...
REDSHIFT_EVENT_METRIC = os.getenv("REDSHIFT_EVENT_METRIC", "redshift_metric")
REDSHIFT_COMMERCE_WEBHOOK_METRIC = os.getenv(
    "REDSHIFT_COMMERCE_WEBHOOK_METRIC", "redshift_metric"
)
