...
REDSHIFT_MESSAGE_TEMPLATE_METRIC = os.getenv("REDSHIFT_MESSAGE_TEMPLATE_METRIC", "redshift_metric")
REDSHIFT_MESSAGE_TEMPLATE_STATUS_METRIC = os.getenv("REDSHIFT_MESSAGE_TEMPLATE_STATUS_METRIC", "redshift_metric")
